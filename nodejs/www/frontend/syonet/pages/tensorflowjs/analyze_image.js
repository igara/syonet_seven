...
export default class AnalyzeImagePage {
	 ...
	 */
	view() {
		this.categorys = this.Stores.AnalyzeImageStore.Category()
		this.selectedCategoryID = this.Stores.AnalyzeImageStore.SelectedCategoryID()
		...
		if (
			...
			this.Stores.AnalyzeImageStore.Category([this.selectedCategory])
		}
		return (
			<div>
				<div>
