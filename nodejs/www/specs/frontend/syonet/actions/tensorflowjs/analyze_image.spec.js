...
describe('onInputModelName', () => {
	...
	test('changed', async () => {
		Stores.AnalyzeImageStore.ModelName('')
		expect(Stores.AnalyzeImageStore.ModelName()).toBe('')
		...
		expect(Stores.AnalyzeImageStore.ModelName()).toBe('test')
	})
})
...
describe('onClickCategoryName', () => {
	...
	test('clicked', async () => {
		Stores.AnalyzeImageStore.SelectedCategoryID(4)
		expect(Stores.AnalyzeImageStore.SelectedCategoryID()).toBe(4)
	})
})
